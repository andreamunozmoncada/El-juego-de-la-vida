const rows = 60; // Numero de filas
const cols = 60; // Numero de columnas 
...
function createBoard() {
    ...
    for (let i = 0; i < rows; i++) {
        ...
        for (let j = 0; j < cols; j++) {
            ...
            const cell = document.createElement('div'); // Crea un div en cada interacción
...
function calculateBoardStatus(changes) {
    for (let i = 0; i < rows; i++) {
        for (let j = 0; j < cols; j++) {
            ...
            } else if (!isLive && liveCount === 3) {// 2. regla // nace una nueva cedula 
